...
cat > 2026-04-10-owasp-juice-shop.md << 'EOF'
...
cat > 2026-05-15-snort-suricata-ossec.md << 'EOF'
...
cat > 2026-06-01-ctf-mercury-walkthrough.md << 'EOF'
...
cat > 2026-06-10-wazuh-troubleshooting.md << 'EOF'
...
cat > 2026-06-20-python-pygame.md << 'EOF'
