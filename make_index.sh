...
<div class="container">
  ...
  <div class="section-container">
    ...
    <div class="project-card">
      ...
      <div class="d-flex flex-wrap gap-2">
        <!-- 💡 띄어쓰기가 있는 파일명은 %20으로 처리하여 404 에러 원천 차단 -->
        ...
        <a href="또롱이_악성코드_분석_보고서%20(1)_2.pdf" target="_blank" class="btn-custom">📄 악성코드 분석 보고서 →</a>
      </div>
    </div>
  ...
  <div class="section-container">
    ...
    <div class="project-card">
      ...
      <div class="d-flex flex-wrap gap-2">
        ...
        <a href="또롱이_악성코드_분석_보고서%20(1)_2.pdf" target="_blank" class="btn-custom">📄 인프라 악성행위 분석 보고서 →</a>
      </div>
    </div>
...
rm -f tmp_*.txt
echo "타이틀 수정 및 파일명 띄어쓰기 오류 원천 차단 적용 완료!"
