...
1-A. [네트워크 관제 직무용] 메인 페이지 (index.html) 생성

==========================================

cat > index.html << HTML_EOF

<p class="text-secondary fw-bold">🎓 교육: 울산과학대학교 반도체응용 전공 / 이스트캠프 가디언즈 정보보호 인프라 과정 수료</p>
<div class="mt-3 mb-4">
...
1-B. [보안 인프라 엔지니어용] 메인 페이지 (index_engineer.html) 생성
...
<div class="mt-3 mb-4">
  ...
  <span class="badge bg-info text-dark fs-6 me-1">Python Automation</span>
</div>
...
echo "직무별 분리형 포트폴리오(관제/엔지니어) 생성 완료!"
