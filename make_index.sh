...
<div class="container">
  ...
  <div class="section-container">
    ...
    <div class="cap-grid">
      <div class="cap-card">
        ...
        <h3 class="cap-title">보안 인프라 설계 및 구축</h3>
        <p class="cap-desc">Cisco 장비 및 pfSense 방화벽을 활용하여 외부 위협으로부터 안전한 네트워크 토폴로지를 설계하고, 실무 수준의 인프라 망을 직접 구성할 수 있습니다.</p>
      </div>
      <div class="cap-card">
      ...
      <div class="cap-card">
        ...
        <h3 class="cap-title">시스템 무결성 및 로그 관제</h3>
        <p class="cap-desc">Wazuh(SIEM) 및 OSSEC을 연동하여 서버 무결성을 점검하고, 분산된 시스템 로그를 중앙 집중화하여 모니터링하는 관제 환경을 구축해본 경험이 있습니다.</p>
      </div>
      <div class="cap-card">
        <div class="cap-num">CAP • 04</div>
        <h3 class="cap-title">취약점 진단 및 모의해킹</h3>
        <p class="cap-desc">OWASP 기반의 웹 취약점(XSS, SQLi 등)을 진단하고, CTF(Mercury) 등 실전 모의해킹 과정을 통해 공격자의 시각에서 보안 위협을 선제적으로 파악합니다.</p>
      </div>
    </div>
  </div>
  ...
  <div class="section-container">
    ...
    <div class="tech-grid">
      <div class="tech-card">
        <div class="tech-category">네트워크 & 보안 장비</div>
        <span class="tech-badge">Cisco</span>
        <span class="tech-badge">pfSense</span>
        <span class="tech-badge">GNS3</span>
        <span class="tech-badge">VPN</span>
        <span class="tech-badge">Firewall</span>
      </div>
      <div class="tech-card">
        <div class="tech-category">보안 관제 & 모니터링</div>
        <span class="tech-badge">Wazuh (SIEM)</span>
        <span class="tech-badge">Snort</span>
        <span class="tech-badge">Suricata</span>
        <span class="tech-badge">Wireshark</span>
        <span class="tech-badge">OSSEC</span>
      </div>
      <div class="tech-card">
        <div class="tech-category">시스템 & 인프라</div>
        <span class="tech-badge">Linux (Ubuntu/Kali)</span>
        <span class="tech-badge">Windows Server</span>
        <span class="tech-badge">VirtualBox</span>
        <span class="tech-badge">MariaDB</span>
      </div>
      <div class="tech-card">
        <div class="tech-category">언어 & 자격 검증</div>
        <span class="tech-badge">Python</span>
        <span class="tech-badge">Shell Script</span>
        <span class="tech-badge">네트워크관리사 2급</span>
      </div>
    </div>
  </div>
  ...
  <div class="section-container">
    ...
    <div class="project-card" style="border: 2px solid #0ea5e9;">
      ...
      <h3 class="project-title">가디언즈 2차 팀 프로젝트</h3>
      <div class="project-tags">
        <span class="project-tag">네트워크 설계</span>
        <span class="project-tag">모의해킹</span>
        <span class="project-tag">방어 인프라</span>
      </div>
      <ul class="project-desc-list">
        <li><strong>보안 인프라 기획 및 설계:</strong> 가상화 환경을 활용한 기업용 보안 인프라 망 설계 및 세부 구축 계획 수립.</li>
        <li><strong>모의해킹 및 취약점 분석:</strong> 구축된 환경을 대상으로 침투 테스트를 진행하고 실질적인 보안 취약점을 식별.</li>
        <li><strong>우수상 수상 성과:</strong> 기획부터 모의해킹 대응 방안까지 체계적인 프로세스를 인정받아 부트캠프 프로젝트 우수상 수상.</li>
      </ul>
      <div class="d-flex flex-wrap gap-2">
        <a href="2차프로젝트 우수상_상장.jpg" target="_blank" class="btn-custom" style="background:#0ea5e9; color:#fff;">🏅 상장 원본 보기 →</a>
        <a href="2_2지(easy)하조_2차팀프로젝트계획서.pdf" target="_blank" class="btn-custom">📄 프로젝트 계획서 →</a>
        <a href="3_2지(easy)하조_모의해킹결과보고서.pdf" target="_blank" class="btn-custom">📄 모의해킹 보고서 →</a>
      </div>
    </div>
    ...
    <div class="project-card">
      ...
      <h3 class="project-title">가디언즈 1차 팀 프로젝트</h3>
      <div class="project-tags">
        <span class="project-tag">인프라 기획</span>
        <span class="project-tag">망 분리</span>
      </div>
      <ul class="project-desc-list">
        <li><strong>인프라 아키텍처 수립:</strong> 요구사항 분석을 통한 초기 네트워크 망 구조 및 서버 인프라 설계 보고서 작성.</li>
      </ul>
    ...
    <div class="project-card">
      ...
      <h3 class="project-title">보안 인프라 및 모의해킹 실습</h3>
      <div class="project-tags">
        <span class="project-tag">Snort/Suricata</span>
        <span class="project-tag">Wazuh</span>
        <span class="project-tag">CTF</span>
      </div>
      <ul class="project-desc-list">
        <li><strong>NIDS/NIPS 룰셋 기반 탐지:</strong> Snort와 Suricata를 활용하여 패킷 스니핑 및 비정상 트래픽 탐지/차단 실습.</li>
        <li><strong>웹 취약점 진단 및 로그 통합:</strong> OWASP 기반 취약점 실습 및 Wazuh 연동을 통한 보안 이벤트 중앙 모니터링 실습.</li>
      </ul>
      <div class="d-flex flex-wrap gap-2">
        <a href="홍기수_보안 인프라 실습 과제3.pdf" target="_blank" class="btn-custom">📄 실습 과제 3 (IDS/IPS) →</a>
        <a href="홍기수_보안 인프라 실습 과제4.pdf" target="_blank" class="btn-custom">📄 실습 과제 4 (CTF/Wazuh) →</a>
        <a href="기업정보보호관리_과제_홍기수.pdf" target="_blank" class="btn-custom">📄 기업정보보호관리 과제 →</a>
      </div>
    </div>
  </div>
